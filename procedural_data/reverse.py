"""Reverse task dataset for sequence manipulation training.

This module provides a procedurally generated dataset where the model must
predict the reverse of an input sequence.
"""
...
class ReverseDataset(Dataset):
    """Procedurally generated dataset for the reverse task.

    Each sample is a random sequence of tokens, and the target is the reverse
    of that sequence.
    ...
    def __init__(
        ...
        """Initializes the reverse task dataset.
    ...
    def _generate_reverse_sequence(
        self,
        seed: int,
    ) -> tuple[Tensor, Tensor, Tensor]:
        """Generates a sequence and its reversed version.
        ...
        sequence = sequence + [self.separator_token] + reversed_sequence
    ...
    def __getitem__(self, idx: int) -> dict[str, Tensor]:
        """Retrieves a single sample for the reverse task.
        ...
        """
        sequence, target, loss_mask = self._generate_reverse_sequence(self.seed + idx)
...
def build_dataloader(
    ...
    """Builds train and validation dataloaders for the reverse task dataset.
